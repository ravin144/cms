...
CREATE TABLE `dc_database` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='数据库';
...
-- ----------------------------
INSERT INTO `dc_admin_user` VALUES ('1', '1', 'admin', 'e3ab392241582a9c5023733036886f12', '65a0c', '83', '1508595779', '127.0.0.1', '1431960099');
...
INSERT INTO `dc_database` VALUES ('3', '2017-10-21-8328a5e84fc467d7083c6ddbf87d0f24.sql', '1508595811');
